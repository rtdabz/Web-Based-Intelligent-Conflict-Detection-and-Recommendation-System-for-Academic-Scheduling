...
class SubjectSeeder extends Seeder
{
     ...
     * - GEC xxx             -> category 'gec',   department = CAS (Rule Engine: CAS-only)
     * - GEE xxx             -> category 'gee',   department = null (Rule Engine: any instructor)
     * - PATH FIT x          -> category 'pathfit', department = CAS (ASSUMPTION - confirm)
     * - ROTC/CWTS xxx       -> category 'nstp',  department = CAS (ASSUMPTION - confirm)
     * - Research1, Capstone Project 1/2, Practicum -> category 'major' (no dedicated
     *   enum value exists for research/capstone/practicum; using 'major' since they
     *   are IT-program-specific requirements, not general education)
     *
    ...
    public function run(): void
    {
        ...
        $subjects = [
            ...
            ['subject_code' => 'ROTC/CWTS 101', 'subject_name' => 'Basic Army Science/CWTS', 'lecture_hours' => 3, 'lab_hours' => 0, 'subject_category' => 'nstp', 'room_type_required' => 'lecture', 'year_level' => '1', 'semester' => '1st', 'department_id' => $cas],
            ...
            ['subject_code' => 'GEC 2', 'subject_name' => 'Readings in Philippine History', 'lecture_hours' => 3, 'lab_hours' => 0, 'subject_category' => 'gec', 'room_type_required' => 'lecture', 'year_level' => '1', 'semester' => '2nd', 'department_id' => $cas],
            ['subject_code' => 'ROTC/CWTS 102', 'subject_name' => 'Reserved Officer Training Corps/CWTS', 'lecture_hours' => 3, 'lab_hours' => 0, 'subject_category' => 'nstp', 'room_type_required' => 'lecture', 'year_level' => '1', 'semester' => '2nd', 'department_id' => $cas],
            ...
            ['subject_code' => 'PATH FIT 3', 'subject_name' => 'Dance Sports/In-Dual/Group/Outdoor', 'lecture_hours' => 2, 'lab_hours' => 0, 'subject_category' => 'pathfit', 'room_type_required' => 'field', 'year_level' => '2', 'semester' => '1st', 'department_id' => $cas],
            ...
            ['subject_code' => 'GEC 4', 'subject_name' => 'Mathematics in the Modern World', 'lecture_hours' => 3, 'lab_hours' => 0, 'subject_category' => 'gec', 'room_type_required' => 'lecture', 'year_level' => '2', 'semester' => '2nd', 'department_id' => $cas],
            ['subject_code' => 'GEE 6', 'subject_name' => 'Art Appreciation', 'lecture_hours' => 3, 'lab_hours' => 0, 'subject_category' => 'gee', 'room_type_required' => 'lecture', 'year_level' => '2', 'semester' => '2nd', 'department_id' => null],
            ['subject_code' => 'GEE 8', 'subject_name' => 'Ethics', 'lecture_hours' => 3, 'lab_hours' => 0, 'subject_category' => 'gee', 'room_type_required' => 'lecture', 'year_level' => '2', 'semester' => '2nd', 'department_id' => null],
            ...
            ['subject_code' => 'GEC 5', 'subject_name' => 'Purposive Communication', 'lecture_hours' => 3, 'lab_hours' => 0, 'subject_category' => 'gec', 'room_type_required' => 'lecture', 'year_level' => '3', 'semester' => '1st', 'department_id' => $cas],
            ['subject_code' => 'GEC 7', 'subject_name' => 'Science, Technology and Society', 'lecture_hours' => 3, 'lab_hours' => 0, 'subject_category' => 'gec', 'room_type_required' => 'lecture', 'year_level' => '3', 'semester' => '1st', 'department_id' => $cas],
            ['subject_code' => 'GEC 9', 'subject_name' => 'Life, Works & Writing of Dr. Jose Rizal', 'lecture_hours' => 3, 'lab_hours' => 0, 'subject_category' => 'gec', 'room_type_required' => 'lecture', 'year_level' => '3', 'semester' => '1st', 'department_id' => $cas],
            ['subject_code' => 'GEE 9', 'subject_name' => 'Technopreneurship (The Entrepreneurial Mind)', 'lecture_hours' => 3, 'lab_hours' => 0, 'subject_category' => 'gee', 'room_type_required' => 'lecture', 'year_level' => '3', 'semester' => '1st', 'department_id' => null],
            ...
            ['subject_code' => 'GEE 4', 'subject_name' => 'Living in the IT Era', 'lecture_hours' => 3, 'lab_hours' => 0, 'subject_category' => 'gee', 'room_type_required' => 'lecture', 'year_level' => '3', 'semester' => '2nd', 'department_id' => null],
            ['subject_code' => 'GEE 7', 'subject_name' => 'Gender & Society', 'lecture_hours' => 3, 'lab_hours' => 0, 'subject_category' => 'gee', 'room_type_required' => 'lecture', 'year_level' => '3', 'semester' => '2nd', 'department_id' => null],
            ['subject_code' => 'GEE 10', 'subject_name' => 'Entrepreneurial Management', 'lecture_hours' => 3, 'lab_hours' => 0, 'subject_category' => 'gee', 'room_type_required' => 'lecture', 'year_level' => '3', 'semester' => '2nd', 'department_id' => null],
            ['subject_code' => 'GEE 11', 'subject_name' => 'Phil. Indigenous Communities & Peace Studies Education', 'lecture_hours' => 3, 'lab_hours' => 0, 'subject_category' => 'gee', 'room_type_required' => 'lecture', 'year_level' => '3', 'semester' => '2nd', 'department_id' => null],
