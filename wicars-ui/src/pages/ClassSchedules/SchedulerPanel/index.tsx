...
export default function SchedulerPanel({ autoAssignOnOpen = false }: SchedulerPanelProps) {
  ...
  const plottingGuideSteps = useMemo(() => [
    ...
    { element: "#schedule-builder-generate button", action: "click" as const, skipIfMissing: true, taskHint: "Click Generate to continue.", title: "Generate a schedule", description: "Create a schedule proposal and check it for conflicts.", side: "bottom" as const, align: "end" as const },
