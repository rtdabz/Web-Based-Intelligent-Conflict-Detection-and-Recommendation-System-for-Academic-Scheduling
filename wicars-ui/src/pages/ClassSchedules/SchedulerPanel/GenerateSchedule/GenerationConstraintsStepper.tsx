...
const steps: { id: StepId; title: string; description: string }[] = [
  { id: 1, title: "Preferences", description: "Time block and GEC split" },
  { id: 2, title: "Constraints", description: "Course day and field rules" },
  { id: 3, title: "Review", description: "Confirm and generate" },
];
...
function ProgressStepper({ currentStep }: { currentStep: StepId }) {
  return (
    <nav
      ...
      style={{ borderRadius: 8 }}
      aria-label="Generate schedule steps"
    >
