...
export default function SectionModal({
  ...
  return createPortal(
    <div
      className="fixed inset-0 z-50 flex items-start justify-center overflow-y-auto bg-slate-950/50 p-3 animate-in fade-in duration-150 sm:items-center sm:p-4"
      role="presentation"
    >
      <div
        role="dialog"
